...
@section('title', 'Liked Blog Posts')
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            LIST OF ALL FAVORITE BLOG POSTS
                                ...
                                @foreach($posts as $key=>$post)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('author.post.show', $post->id) }}" class="btn btn-success rounded-0 waves-effect">
                                                <i class="material-icons">visibility</i>
                                            </a>
                                            <button type="button" class="btn btn-danger rounded-0 waves-effect" onclick="removePost({{ $post->id }})">
